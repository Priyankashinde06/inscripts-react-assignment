  ...
  const handleImport = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        <div className="flex flex-col h-screen">
            {showForm && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-lg w-full max-w-md">
                        <h2 className="text-xl font-semibold mb-2">Add New Action</h2>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-end space-x-3">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-[#4B6A4F] text-white rounded hover:bg-[#3a5a3f]"
                                >
                                    Add Action
                                </button>
                            </div>
            ...
            <div className="flex gap-2 px-3 py-1 justify-between border-b border-[#eeeeee] text-sm">
            ...
            <div className="flex w-full">
                <div className="px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee]" style={{ width: 57 }}></div>

                <div className="flex px-2 text-sm truncate gap-2 items-center bg-[#e2e2e2] border border-[#eeeeee] content-center" style={{ width: 724 }}>
                ...
                <div className="px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee]" style={{ width: 219 }}></div>

                <div className="flex px-2 py-1 text-sm text-gray-600 truncate items-center bg-[#d2e0d4] justify-center gap-1 border border-[#eeeeee] cursor-pointer" style={{ width: 158 }}>
                ...
                <div className="flex px-2 py-1 text-sm text-gray-600 truncate items-center justify-center gap-1 bg-[#DCCFFC] border border-[#eeeeee] cursor-pointer" style={{ width: 287 }}>
                ...
                <div className="flex px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee] items-center justify-center bg-[#fac2af] gap-1 cursor-pointer" style={{ width: 150 }}>
                ...
                <div className="flex px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee] bg-[#eeeeee] items-center justify-center cursor-pointer" style={{ width: 150 }}>
                ...
                <div className="flex space-x-4 overflow-x-auto">
                    {['All Orders', 'Pending', 'Reviewed', 'Arrived'].map((tab) => (
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium whitespace-nowrap rounded-md ${
                                activeTab === tab 
